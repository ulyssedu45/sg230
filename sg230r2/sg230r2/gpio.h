...
/* Pad configuration was generated automatically using intelp2m Unknown */
static const struct pad_config gpio_table[] = {
	...
	_PAD_CFG_STRUCT(GPP_B4, PAD_FUNC(NF1) | PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),
	...
	_PAD_CFG_STRUCT(GPP_C4, PAD_FUNC(NF1) | PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),
	...
	_PAD_CFG_STRUCT(GPP_E4, PAD_FUNC(NF1) | PAD_RESET(RSMRST) | PAD_TRIG(OFF) | PAD_BUF(RX_DISABLE), 0),
	...
	_PAD_CFG_STRUCT(GPP_F6, PAD_FUNC(NF1) | PAD_RESET(RSMRST) | PAD_TRIG(OFF) | PAD_BUF(RX_DISABLE), 0),
	...
	_PAD_CFG_STRUCT(GPP_G5, PAD_RESET(PLTRST) | PAD_IRQ_ROUTE(IOAPIC) | PAD_BUF(TX_DISABLE) | (1 << 1), 0),
	...
	/* GPP_G16 - GPIO */
	/* DW0: 0x84000200, DW1: 0x00001000 */
	PAD_CFG_TERM_GPO(GPP_G16, 0, DN_20K, PLTRST),
	...
	_PAD_CFG_STRUCT(GPP_H1, PAD_FUNC(NF1) | PAD_RESET(DEEP) | PAD_TRIG(OFF) | PAD_BUF(TX_RX_DISABLE) | (1 << 1), 0),

	/* GPP_H2 - SRCCLKREQ8# */
	/* DW0: 0x84000500, DW1: 0x00000000 */
	/* DW0: PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE) - IGNORED */
	/* PAD_CFG_NF(GPP_H2, NONE, PLTRST, NF1), */
	_PAD_CFG_STRUCT(GPP_H2, PAD_FUNC(NF1) | PAD_RESET(PLTRST) | PAD_TRIG(OFF) | PAD_BUF(TX_DISABLE), 0),
